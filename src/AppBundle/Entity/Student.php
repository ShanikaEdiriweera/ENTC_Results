...
class Student
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="student_module_grade", mappedBy="student")
     */
    protected $grades;
     ...
     * Add grade
     *
     * @param \AppBundle\Entity\student_module_grade $grade
     *
     * @return Student
     */
    public function addGrade(\AppBundle\Entity\student_module_grade $grade)
    {
        $this->grades[] = $grade;
     ...
     * @param \AppBundle\Entity\student_module_grade $grade
     */
    public function removeGrade(\AppBundle\Entity\student_module_grade $grade)
    {
